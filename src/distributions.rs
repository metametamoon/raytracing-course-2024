...
pub trait SampleDistribution {
    fn sample(&self, point: &Vec3f, normal: &Vec3f, rng: &mut ThreadRng) -> Vec3f;
...
impl SampleDistribution for SemisphereUniform {
    fn sample(&self, _: &Vec3f, normal: &Vec3f, rng: &mut ThreadRng) -> Vec3f {
...
impl SampleDistribution for LightSamplingDistribution {
    fn sample(&self, point: &Vec3f, _normal: &Vec3f, rng: &mut ThreadRng) -> Vec3f {
...
impl SampleDistribution for MixDistribution {
    fn sample(&self, point: &Vec3f, normal: &Vec3f, rng: &mut ThreadRng) -> Vec3f {
        ...
        self.distributions[rand_idx].sample(point, normal, rng)
    }
